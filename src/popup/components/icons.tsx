...
// Stroke-based, 24×24 viewBox, sized via CSS (width/height default 16).

type IconProps = SVGProps<SVGSVGElement> & { readonly size?: number };

function Icon({ size = 16, children, ...rest }: IconProps): ReactElement {
  return (
    <svg
      width={size}
      height={size}
...
export function ZapIcon(props: IconProps): ReactElement {
  return (
    <Icon {...props}>
...
export function BarChartIcon(props: IconProps): ReactElement {
  return (
    <Icon {...props}>
...
export function GaugeIcon(props: IconProps): ReactElement {
  return (
    <Icon {...props}>
      <path d="m12 14 4-4" />
...
export function RotateCcwIcon(props: IconProps): ReactElement {
  return (
    <Icon {...props}>
...
export function PowerIcon(props: IconProps): ReactElement {
  return (
    <Icon {...props}>
